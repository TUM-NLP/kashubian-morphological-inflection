...
This directory contains Slavic morphological inflection datasets in the UniMorph 4.0 schema (as defined in https://aclanthology.org/2022.lrec-1.89/) and Kashubian (and Polish) monolingual sentences used for pre-training and synthetic Kashubian data generation. It includes data from the SIGMORPHON–UniMorph 2023 Shared Task (https://aclanthology.org/2023.sigmorphon-1.13/), legacy UniMorph datasets (https://unimorph.github.io/) reformatted for schema consistency, and monolingual sentences from the Leipzig Corpora Collection ([aclanthology.org/L12-1154](https://aclanthology.org/L12-1154/)).
