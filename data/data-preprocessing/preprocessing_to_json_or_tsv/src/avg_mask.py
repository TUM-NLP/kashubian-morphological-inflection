...
# load dataset
lang = "csb-pol-sent"
train_path = f"<path_to>/kashubian-morphological-inflection/data/data-preprocessing/preprocessing_to_json_or_tsv/data/{lang}_trn.tsv"
eval_path = f"<path_to>/kashubian-morphological-inflection/data/data-preprocessing/preprocessing_to_json_or_tsv/data/{lang}_dev.tsv"
